...
public class FeedHeaterServiceTest {
    ...
    private SimplePage<UserDto> userDtos;
    private SimplePage<UserDto> emptyUserDtos;
    ...
    void setUp() {
        ...
        secondUser = UserDto.builder()
                ...
                .followeeIds(userFollowees)
                .build();
        userDtos = new SimplePage<>(List.of(firstUser, secondUser));
        emptyUserDtos = new SimplePage<>(Collections.emptyList());
    }
